...
Cohesion: 0.06
Nodes (76): PyatsGoldenConfig, PyatsParserCatalog, PyatsParserCatalogRefreshSchedule, PyatsSnapshot, Cached parser-discovery surface for one Genie-supported pyATS os (ATW-241/249)., Opt-in intent model for recurring parser-catalog refresh (ATW-581).      A singl, One captured config/state/full snapshot for a NetBox Device.      Populated by t, Map status to a NetBox color label for table badges. (+68 more)
...
### Community 32 - "PyatsComplianceRunCleanTest"
Cohesion: 0.15
...
### Community 36 - "EncryptDecryptTest"
Cohesion: 0.17
...
### Community 39 - "run_parser_catalog_refresh_schedules_job"
Cohesion: 0.17
...
### Community 40 - "TestSupportedPlatformsMap"
Cohesion: 0.11
...
### Community 43 - "test_pr_body_scrub_guard.py"
Cohesion: 0.18
...
### Community 65 - "PyatsSnapshotDiffModelTest"
Cohesion: 0.24
...
### Community 66 - "get_worker_status"
Cohesion: 0.21
...
### Community 67 - "_resolve_parse_context"
Cohesion: 0.21
...
### Community 69 - "ADR-0002: Multi-vendor graceful degradation pattern"
Cohesion: 0.18
...
### Community 70 - "Graphify MCP HTTP server — multi-host / shared-service runbook"
Cohesion: 0.18
...
### Community 73 - "GenieLearnViewTest"
Cohesion: 0.18
...
### Community 75 - "test_search_index_guard.py"
Cohesion: 0.24
...
### Community 77 - "ADR-0003: NetBox 4.6 migration dependencies and worker build toolchain"
Cohesion: 0.20
...
### Community 78 - "ADR-0005: PyatsJob unified job-tracking model + status vocabulary extension"
Cohesion: 0.20
...
### Community 84 - "TestStateCommandsInvariant"
Cohesion: 0.20
...
### Community 87 - "Scheduled parser-catalog refresh"
Cohesion: 0.22
...
### Community 93 - "Compliance engine"
Cohesion: 0.25
...
### Community 106 - "ADR-0007: Device-page tab via `register_model_view` + `ObjectView` + `ViewTab`"
Cohesion: 0.33
...
### Community 111 - "batch_capture_job"
Cohesion: 0.33
Nodes (6): batch_capture_job(), _finish_partial(), _persist_snapshot(), RQ worker entry point — capture snapshots for a batch of devices.      NetBox's, Set a batch :class:`PyatsJob` to ``partial`` with batch counts (ADR-0005 §3 + §2, Persist a successful-path :class:`PyatsSnapshot` row from a capture result.
