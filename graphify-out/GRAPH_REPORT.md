...
- 0003-netbox46-migration-and-worker-toolchain.md
...
### Community 28 - "PyatsCredentialViewTest"
Cohesion: 0.20
...
### Community 29 - "0003-netbox46-migration-and-worker-toolchain.md"
Cohesion: 0.16
...
### Community 39 - "graphify reference: transcribe video and audio"
Cohesion: 0.33
...
### Community 41 - "pyats-entrypoint.sh"
Cohesion: 0.33
Nodes (5): For /graphify explain, For /graphify path, graphify reference: query, path, explain, Step 0 — Constrained query expansion (REQUIRED before traversal), Step 1 — Traversal

### Community 42 - "pyats-worker-entrypoint.sh"
Cohesion: 0.14
...
### Community 43 - "0004_reconcile_netboxmodel_fields.py"
Cohesion: 0.50
Nodes (3): For /graphify add, For --watch, graphify reference: add a URL and watch a folder

### Community 44 - "extraction-spec.md"
Cohesion: 0.50
Nodes (3): For git commit hook, For native CLAUDE.md integration, graphify reference: commit hook and native CLAUDE.md integration

### Community 45 - "configuration.py"
Cohesion: 0.50
Nodes (3): For --cluster-only, For --update (incremental re-extraction), graphify reference: incremental update and cluster-only

### Community 50 - "netbox-pyats"
Cohesion: 0.14
...
- **Why does `PyatsCredential` connect `capture_snapshot` to `SnapshotStatusChoices`, `views.py`, `PyatsCredential`, `AGENTS.md`, `PyatsSnapshot`, `pyats-worker-entrypoint.sh`, `template_content.py`, `0003-netbox46-migration-and-worker-toolchain.md`, `DeviceCaptureView`, `ADR-0001: Plugin package layout`, `.get_password`, `.set_enable_secret`, `.set_password`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `PyatsSnapshot` connect `capture_snapshot` to `build_testbed`, `SnapshotStatusChoices`, `graphify.js`, `AGENTS.md`, `pyats-worker-entrypoint.sh`, `netbox-pyats`, `DeviceCaptureView`, `dev-worktree.sh`, `[0.1.0] - Unreleased`, `Architecture Decision Records`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `PyatsComplianceRun` connect `capture_snapshot` to `SnapshotStatusChoices`, `graphify.js`, `AGENTS.md`, `pyats-worker-entrypoint.sh`, `netbox-pyats`, `DeviceCaptureView`, `.get_result_color`, `.has_drift`, `.has_warnings`, `Architecture Decision Records`?**
